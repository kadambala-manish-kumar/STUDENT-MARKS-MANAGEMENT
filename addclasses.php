...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
     ...
     $connection= mysqli_connect($Server,$username,$psrd,$dbname);
         ...
         $query="insert into classes(ClassTitle,Year,BatchNo) values('$ClassName','$year','$BatchNo')";
         if($ret= mysqli_query($connection,$query)==TRUE){
			 $sql = "CREATE TABLE '$ClassName' (RollNo VARCHAR(255))";
        ...
        <div class="panel-body">
          <form method="POST" enctype="multipart/form-data" action="#" role="form" name="CandidateForm" >
            ...
            <div class="form-group">
              ...
              <input type="text" name="ClassName" maxlength="50" class="form-control" required>
            </div>
          
            <div class="form-group">
              <label class="control-label" for="year">year</label>
              <input  type="text" name="year" maxlength="50" class="form-control" required>
            </div>
            <div class="form-group">
              <label class="control-label">Batch No.</label>
              <input  type="text" name="BatchNo" maxlength="50" class="form-control" required>
            </div>
            <div class="form-group">
              <button id="signupSubmit" type="submit" class="btn btn-info btn-block">Add Clas Now</button>
            </div>
