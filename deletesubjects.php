...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
     ...
     $ec=$_POST['selectsubject'];

    $query="delete from Subjects where SubID='$ec'";
...
<div class="dropdown">
 ...
 <div class="col-sm-10">
 <br><div align="center">
 <select name="selectsubject" id="selectsubject" onchange="fetch_select(this.value);">
 <option hidden>Select subject</option>
  <?php
    $ci=$_POST['selectsubject'];
	$query="select SubID from Subjects where SubID='$ci' group by SubID";
  $select=mysqli_query($connection,$query);

  while($row=mysqli_fetch_array($select))
  {
   echo "<option>".$row['SubID']."</option>";
  }
