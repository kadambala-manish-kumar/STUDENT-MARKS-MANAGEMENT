...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
     ...
     $connection= mysqli_connect($Server,$username,$psrd,$dbname);
         ...
         $query="insert into Faculty(FID,Name,Password) values('$FID','$Username','$Password')";
      ...
      <div class="panel panel-primary">
        <div class="panel-body">
          <form method="POST" enctype="multipart/form-data" action="#" role="form" name="CandidateForm" onsubmit="return ValidateCandidateForm();">
			...
			<div class="form-group">
              <label class="control-label" for="FID">Faculty ID</label>
              <input  type="text" name="FID" maxlength="50" class="form-control" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <button id="signupSubmit" type="submit" class="btn btn-info btn-block">Add Faculty</button>
            </div>
